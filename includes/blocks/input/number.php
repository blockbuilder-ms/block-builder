...
class Number extends Block
{
    ...
    protected function _controls(): array
    {
         ...
         */
        do_action('bb_number_before_controls', $controls);
         ...
         */
        do_action('bb_number_after_controls', $controls);
    ...
    {
        return [
            "class", "id", "value", "name", "max", "min", "style", "x-action", "x-options", "onClick",
