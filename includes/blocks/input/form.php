...
class Form extends Block
{
    ...
    protected function _controls(): array
    {
         ...
         */
        do_action('bb_form_before_controls', $controls);
         ...
         */
        do_action('bb_form_after_controls', $controls);
    ...
    protected function _attributes(): array
    {
        return [
            ...
            "onMouseOver", "onMouseOut", "onSubmit", "method", "enctype"
        ];
    }
    ...
    {
        return "<form x-inner-content></form>";
    }
}
