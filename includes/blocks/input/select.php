...
class Select extends Block
{
    ...
    protected function _controls(): array
    {
         ...
         */
        do_action('bb_select_before_controls', $controls);
         ...
         */
        do_action('bb_select_after_controls', $controls);
    ...
    {
        return [
            "class", "id", "name", "value", "style", "x-action", "x-options", "onClick",
    ...
    {
        return "<div><select>{options}</select></div>";
    }
}
