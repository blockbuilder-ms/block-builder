...
class Radiobox extends Block
{
    ...
    protected function _controls(): array
    {
         ...
         */
        do_action('bb_radio_before_controls', $controls);
         ...
         */
        do_action('bb_radio_after_controls', $controls);
    ...
    {
        return [
            "class", "id", "value", "name", "checked", "style", "x-action", "x-options", "onClick",
