...
class PriceTable extends Block
{
    /**
     ...
     * @var string
     */
    protected $tag = "core:price-table";
    ...
    protected function _controls(): array
    {
         ...
         */
        do_action("bb_price_table_before_controls", $controls);
         ...
         */
        do_action("bb_price_table_after_controls", $controls);
