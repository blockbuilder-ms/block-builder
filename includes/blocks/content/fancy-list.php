...
class FancyList extends Block
{
    ...
    protected function _controls(): array
    {
         ...
         */
        do_action("bb_fancy_list_before_controls", $controls);
         ...
         */
        do_action("bb_fancy_list_after_controls", $controls);
