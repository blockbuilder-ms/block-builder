...
class ContentBox extends Block
{
    /**
     ...
     * @var string
     */
    protected $tag = "core:content_box";
    ...
    protected function _controls(): array
    {
         ...
         */
        do_action("bb_content_box_before_controls", $controls);
         ...
         */
        do_action("bb_content_box_after_controls", $controls);
