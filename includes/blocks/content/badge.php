...
class Badge extends Block
{
    ...
    protected function _controls(): array
    {
         ...
         */
        do_action('bb_badge_before_controls', $controls);
         ...
         */
        do_action('bb_badge_after_controls', $controls);
    ...
    {
        return "<div><span x-content></span></div>";
    }
}
