...
namespace BB\Includes\Blocks\Button;

use BB\Includes\Blocks\Block;

class FancyLink extends Block
{
    /**
    ...
    protected function _controls(): array
    {
         ...
         */
        do_action('bb_fancy-link_before_controls', $controls);
        ...
        $controls->section([
            ...
            "name" => "fancy-link",
            "belongs-to" => "fancy-link",
            "description" => "Contains modifications regarding external and internal fancy-link."
        ], function ($controls) {
            $controls->toggle([
                'label' => 'Internal Link?',
                'target' => 'href',
         ...
         */
        do_action('bb_fancy-link_after_controls', $controls);
    ...
    {
        return [
            "class", "id", "href", "title", "style", "x-action", "x-options", "onClick",
