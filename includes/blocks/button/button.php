...
class Button extends Block
{
    ...
    protected function _controls(): array
    {
         ...
         */
        do_action('bb_button_before_controls', $controls);
         ...
         */
        do_action('bb_button_after_controls', $controls);
    ...
    {
        return [
            "class", "id", "type", "label", "href", "title", "style", "x-action", "x-options"
        ];
    }
    ...
    {
        return "<button><span x-icon x-if='icon'></span><span x-content></span></button>";
    }
}
