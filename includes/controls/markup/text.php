<div id="{id}" class="form-group items-center content-center flex mb-4">
    <div x-if="prepend" class="input-prepend py-2 px-2 mt-5">
        {prepend}
    </div>
    <div class="input-field flex flex-wrap w-full">
        ...
        <input x-control-value class="w-full mt-1 py-2 px-4" type="text" name="{target}" />
    </div>
    <div x-if="append" class="input-prepend py-2 px-2 mt-5">
        {append}
    </div>
</div>