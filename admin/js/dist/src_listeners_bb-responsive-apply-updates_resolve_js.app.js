...
(self["webpackChunkblock_builder_editor"] =
  ...
  ["src_listeners_bb-responsive-update-before_resolve_js"],
  {
    /***/ "./src/listeners/bb-responsive-update-before/resolve.js":
      /*!**************************************************************!*\
  !*** ./src/listeners/bb-responsive-update-before/resolve.js ***!
  \**************************************************************/
      /***/ () => {
        eval(
          'const appLoader = window.getAppLoader();\r\n\r\nappLoader.event.on(\r\n  "bb-responsive-update-before",\r\n  async function (event) {\r\n    let frame = document.getElementById("iframe-inner-wrap");\r\n    let viewport = document.getElementById("viewport");\r\n\r\n    let dimension = viewport.value;\r\n    frame.style.maxWidth = dimension + "px";\r\n  },\r\n  function (errorCode, errorData, errorMessage) {\r\n    // Error\r\n    appLoader.debug.log([{ errorCode, errorData, errorMessage }]);\r\n  },\r\n  document\r\n);\r\n\n\n//# sourceURL=webpack://block-builder-editor/./src/listeners/bb-responsive-update-before/resolve.js?'
        );
