...
(self["webpackChunkblock_builder_editor"] =
  ...
  ["src_listeners_bb-block-delete-after_cancel-delete_js"],
  {
    /***/ "./src/listeners/bb-block-delete-after/cancel-delete.js":
      /*!********************************************************************!*\
  !*** ./src/listeners/bb-block-delete-after/cancel-delete.js ***!
  \********************************************************************/
      /***/ () => {
        eval(
          'const appLoader = window.getAppLoader();\r\n\r\nappLoader.event.on(\r\n  "bb-block-delete-after",\r\n  async function (event) {\r\n    let state = event.attributes.state;\r\n\r\n    if (state === "cancel") {\r\n      // Succes\r\n      appLoader.action\r\n        .withOptions({\r\n          id: "builder-confirm-delete",\r\n          standalone: true,\r\n          attributes: {\r\n            item: event.attributes.item,\r\n          },\r\n        })\r\n        .run("modal", "builder-confirm-delete");\r\n    }\r\n  },\r\n  function (errorCode, errorData, errorMessage) {\r\n    // Error\r\n    appLoader.debug.log([{ errorCode, errorData, errorMessage }]);\r\n  },\r\n  document\r\n);\r\n\n\n//# sourceURL=webpack://block-builder-editor/./src/listeners/bb-block-delete-after/cancel-delete.js?'
        );
