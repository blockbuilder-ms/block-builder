...
(self["webpackChunkblock_builder_editor"] =
  ...
  ["src_listeners_bb-block-duplicate-before_confirm-duplicate_js"],
  {
    /***/ "./src/listeners/bb-block-duplicate-before/confirm-duplicate.js":
      /*!*********************************************************************!*\
  !*** ./src/listeners/bb-block-duplicate-before/confirm-duplicate.js ***!
  \*********************************************************************/
      /***/ () => {
        eval(
          'const appLoader = window.getAppLoader();\r\n\r\nappLoader.event.on(\r\n  "bb-block-duplicate-before",\r\n  async function (event) {\r\n    // Succes\r\n    appLoader.action\r\n      .withOptions({\r\n        "data-id": "builder-confirm-duplicate",\r\n        standalone: true,\r\n        attributes: {\r\n          item: event.attributes.item,\r\n        },\r\n      })\r\n      .run("modal", "builder-confirm-duplicate");\r\n\r\n    setTimeout(() => {\r\n      appLoader.loadActions();\r\n    });\r\n  },\r\n  function (errorCode, errorData, errorMessage) {\r\n    // Error\r\n    appLoader.debug.log([{ errorCode, errorData, errorMessage }]);\r\n  },\r\n  document\r\n);\r\n\n\n//# sourceURL=webpack://block-builder-editor/./src/listeners/bb-block-duplicate-before/confirm-duplicate.js?'
        );
