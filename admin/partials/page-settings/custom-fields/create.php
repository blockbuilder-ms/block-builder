        ...
        <div class="w-full flex flex-wrap">
            <div class="w-full flex">
                <div class="flex w-full justify-between bg-white  py-2 px-4 my-2">
                    <span class="w-full">
                        <input type="text" class="transparent-input" placeholder="Field key">
                    </span>
                    <span class="flex w-full items-center content-center">
                        <span class="value">
                            <input type="text" class="transparent-input" placeholder="Field Value">
                        </span>
                    </span>
                </div>
                <span style="width:20px" class="actions flex items-center content-center">
